# Współpraca nad projektem infrash

Dziękujemy za zainteresowanie projektem infrash! Poniżej znajdziesz informacje, jak możesz przyczynić się do rozwoju biblioteki.
...
```bash
git clone https://gitlab.com/infrash/python.git
cd infrash
```
...
Projekt infrash koncentruje się na tworzeniu bezpiecznych narzędzi dla dzieci. Prosimy o przestrzeganie następujących zasad:
...
Dziękujemy za Twój wkład w projekt infrash!